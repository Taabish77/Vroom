...
function setup() {
 ...
 car1= createSprite(50,height-70,20,50);
  
  
  car1.addImage(carImage);
  car1.setCollider('circle',0,0,350)
  car1.scale = 0.8
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    ...
    switch(rand) {
      case 1: obstacle.addImage(OppCarIm);
              break;
      case 2: obstacle.addImage(OppCarIm);
              break;
      default: break;
    }
